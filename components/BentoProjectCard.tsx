...
const BentoProjectCard = ({ project, size, index }: BentoProjectCardProps) => {
  ...
  return (
    <div
      className={`
        group relative overflow-hidden rounded-xl bg-theme-card
      ...
      >
        ...
        <div className="p-3 md:p-4">
          <div className="flex items-center gap-2 mb-1">
            <span className="text-xs font-medium text-theme-accent bg-[var(--surface-glass)] px-2 py-0.5 rounded">
              {project.year}
            </span>
          </div>
          <h4
            className={`
              font-strong text-theme-heading mb-1 line-clamp-2
        ...
        <div className="absolute top-3 right-3 opacity-0 transform translate-x-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0">
          <span className="inline-flex items-center justify-center w-7 h-7 bg-theme-card-alt rounded-full text-theme-accent shadow-md">
