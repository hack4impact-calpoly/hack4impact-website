  ...
  return (
    <>
      ...
      <main className="overflow-x-hidden">
        ...
        <section className="hero-landing relative min-h-screen w-full overflow-hidden">
          ...
          >
            <span
              className="animate-shoot absolute top-[6%] left-[70%] h-[1px] w-[80px] rotate-[215deg] rounded-full bg-gradient-to-r from-white/90 to-transparent shadow-[0_0_6px_2px_rgba(255,80,80,0.6)]"
              style={{ animationDelay: "1s" }}
            />
            <span
              className="animate-shoot absolute top-[10%] left-[40%] h-[1px] w-[60px] rotate-[220deg] rounded-full bg-gradient-to-r from-white/80 to-transparent shadow-[0_0_6px_2px_rgba(255,80,80,0.5)]"
              style={{ animationDelay: "5s" }}
            />
            <span
              className="animate-shoot absolute top-[4%] left-[85%] h-[1px] w-[90px] rotate-[210deg] rounded-full bg-gradient-to-r from-white/90 to-transparent shadow-[0_0_8px_3px_rgba(255,60,60,0.7)]"
              style={{ animationDelay: "9s" }}
            />
            <span
              className="animate-shoot absolute top-[14%] left-[55%] h-[1px] w-[70px] rotate-[225deg] rounded-full bg-gradient-to-r from-white/80 to-transparent shadow-[0_0_6px_2px_rgba(255,80,80,0.5)]"
          ...
          <div className="relative z-30 flex items-start justify-center px-4 pt-4 sm:px-5 sm:pt-8 md:px-5 md:pt-10 lg:px-6 lg:pt-14">
            ...
            >
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                We build thoughtful, dependable software for nonprofits doing
                meaningful work, giving teams tools that feel as intentional as
        ...
        <section className="relative z-10 -mt-56 px-4 pb-32 sm:px-5 md:-mt-36 md:px-5 lg:-mt-28 lg:px-6 xl:-mt-12">
          <motion.div
            className="mx-auto max-w-3xl rounded-[28px] border border-theme-border bg-[var(--surface-glass)] px-6 pb-5 text-center backdrop-blur-[2px] sm:px-8 sm:pb-6"
          ...
          >
            ...
            >
              <span className="text-[#f6c56f]">Hack4Impact</span> makes the
          ...
          >
            <p className="text-xs font-medium uppercase tracking-[0.2em] text-theme-muted sm:text-sm">
                  ...
                  <div key={set} className="flex items-center gap-14">
                    <div className="flex h-12 w-36 shrink-0 items-center justify-center sm:h-14 sm:w-40">
                      <img
                        ...
                        src="/assets/nonprofits/ecologistics.png"
                        alt="Ecologistics"
                      />
                    </div>
                    <div className="flex h-12 w-36 shrink-0 items-center justify-center sm:h-14 sm:w-40">
                      <img
                        className="max-h-full max-w-full object-contain opacity-70"
                        src="/assets/nonprofits/habitat.png"
                        alt="Habitat for Humanity"
                      />
                    </div>
                    <div className="flex h-12 w-36 shrink-0 items-center justify-center sm:h-14 sm:w-40">
                      <span className="text-sm font-medium tracking-wide text-theme-faint">
                    ...
                    <div className="flex h-12 w-36 shrink-0 items-center justify-center sm:h-14 sm:w-40">
                      <img
                        className="max-h-full max-w-full object-contain opacity-70"
                        src="/assets/nonprofits/ecoslo.png"
                        alt="ECOSLO"
                      />
                    </div>
                    <div className="flex h-12 w-36 shrink-0 items-center justify-center sm:h-14 sm:w-40">
                      <img
                        className="max-h-full max-w-full object-contain opacity-70"
                        src="/assets/nonprofits/paso-food-coop.png"
                        alt="Paso Robles Food Co-Op"
                      />
                    </div>
                    <div className="flex h-12 w-36 shrink-0 items-center justify-center sm:h-14 sm:w-40">
                      <span className="text-sm font-medium tracking-wide text-theme-faint">
